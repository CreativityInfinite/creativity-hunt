...
import { ContextMenu, ContextMenuContent, ContextMenuItem, ContextMenuTrigger } from '@component/ui/context-menu';
...
const LogoImage = ({ src, alt, className, ...props }: LogoImageProps) => <img src={src} alt={alt} className={cn('block h-8', className)} {...props} />;

const LogoImageMobile = ({ src, alt, className, ...props }: LogoImageProps) => <img src={src} alt={alt} className={cn('flex h-8 md:hidden', className)} {...props} />;

const LogoImageDesktop = ({ src, alt, className, ...props }: LogoImageProps) => <img src={src} alt={alt} className={cn('hidden h-8 md:flex', className)} {...props} />;
